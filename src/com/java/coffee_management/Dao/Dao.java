...
public class Dao {
    ...
    public List<category234> getAllCategory_234() {
        List<category234> empl = new ArrayList<>();
        Connection connect = ConnectSQL.getConnection();
        ...
        try {
            ...
            ResultSet rs = pr.executeQuery();
            while (rs.next()) {
                category234 tk = new category234();
    ...
    public Employee login_234(String userName, String pass) {
        Connection connect = ConnectSQL.getConnection();
        ...
        try {
            ...
            if (rs.next()) {
                ...
                emp.setTennv(rs.getString("name"));
                return emp;
            }
        } catch (Exception ex) {
            ex.printStackTrace();
