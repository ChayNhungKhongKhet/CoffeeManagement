 ...
 * @author ANH TUAN
 */
public class Selll extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Selll.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
